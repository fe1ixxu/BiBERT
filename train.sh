...
--attention-dropout 0.1 --activation-dropout 0.1 --max-update 10000 --save-dir ${SAVE_DIR}  --encoder-embed-dim 768 --decoder-embed-dim 768 \
--no-epoch-checkpoints --save-interval 5 --pretrained_model Coran/bibert-ende --use_drop_embedding 8  #-distributed-world-size 4
