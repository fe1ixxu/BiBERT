...
--activation-dropout 0.1 --max-update 100000 --save-dir ${SAVE_DIR}  --encoder-embed-dim 768 --decoder-embed-dim 768 --no-epoch-checkpoints \
--max-source-positions 512 --max-target-positions 512 --pretrained_model Coran/bibert-ende --use_drop_embedding 8 
