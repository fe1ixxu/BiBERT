...
@register_model("transformer-bert-fuse")
class Transformer2Model(FairseqEncoderDecoderModel):
    """
    Transformer model from `"Attention Is All You Need" (Vaswani, et al, 2017)
    <https://arxiv.org/abs/1706.03762>`_.
    ...
    @classmethod
    def build_encoder(cls, args, src_dict, embed_tokens):
        return Transformer2Encoder(args, src_dict, embed_tokens)
...
class Transformer2Decoder(FairseqIncrementalDecoder):
    """
    Transformer decoder consisting of *args.decoder_layers* layers. Each layer
    is a :class:`TransformerDecoderLayer`.
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        return Transformer2DecoderLayer(args, no_encoder_attn)
...
@register_model_architecture("transformer-bert-fuse", "transformer2_wmt_en_de")
def transformer2_wmt_en_de(args):
    base_architecture(args)
