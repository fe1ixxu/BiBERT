...
from .transformer_sentence import init_bert_params, TransformerSentenceEncoder, LayerNorm
...
class RobertaModel(FairseqLanguageModel):
    ...
    @classmethod
    def from_pretrained(cls, model_name_or_path, checkpoint_file='model.pt', data_name_or_path='.', bpe='wordpiece', **kwargs):
